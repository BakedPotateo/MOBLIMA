...
public class MovieTest {
    public static void main(String[] args) {
        ...
        movieController.createNewMovie(4, "People in Paris", "Hood Classic", "Some people of color visiting Paris", "M18", "Kanye East", cast, 3.0, somePastDay.minusDays(10), somePastDay);
